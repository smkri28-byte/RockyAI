...
# ============================================================
# REMEMBER ME - AUTO LOGIN PERSISTENCE
# ============================================================
...
# AUTO-LOGIN CHECK - If not logged in, check remembered file
...
def login_user(username, password):
    ...
    if check_password_hash(user["password_hash"], password):
        ...
        st.session_state.username = user["username"]
        st.session_state.role = user["role"]
        save_remembered_user(user["username"], user["role"])
        ...
        if st.button(
            ...
            if new_password!= confirm_password:
                ...
                if success:
                    ...
                    auto_login_user(new_username.strip())
                    st.rerun()
                else:
                    st.error(message)
