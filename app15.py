...
def v19_chat_ui():
    ...
    st.markdown(f"<div class='v19-topbar'><div><div class='v19-brand'>🏔️ RockyAIv1-9</div><div class='v19-sub'>AI powered personal workspace</div></div><div class='v19-status'><span></span> Online</div></div>", unsafe_allow_html=True)
    ...
    if prompt and prompt.strip():
        ...
        instruction = '''
You are RockyAIv1-9, a unified all-in-one personal AI workspace chatbot. Never force the user to leave the conversation to use a capability. Treat the RockyAI extensions as capabilities available inside the same chat.
