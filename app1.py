...
app.secret_key = "ae1ca680b123bd6926b1ad5ce228071c0d632b2ad2827e37"
...
<div class="auth-container">
    ...
    <div style="margin-top: 25px; border-top: 1px solid #222; padding-top: 20px;">
        <form method="POST" action="/admin-login-direct">
            <div class="form-group">
                <label style="font-size: 13px; color: #e67e22;">Admin Panel Key</label>
...
<div class="dashboard-container">
    <div class="nav-bar">
        <h1>RockyAI, AI assistant for studies</h1>
        <div>
            {% if role == 'admin' %}
...
def run_feature():
    ...
    if feature == "ask_ai":
        if not query: 
            ...
            prompt = f"You are RockyAI, a CBSE AI Assistant. Explain simply with step-by-step logic. Question: {query}"
